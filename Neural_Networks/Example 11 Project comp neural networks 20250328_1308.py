...
x_valid = returns01_valid[[             'zlnlag1mcreal',
                'finlag1bmmiss',        'zfinlag1bm',
                                        'zfing01dyadj',
                'fing02esgmiss',        'zfing02esg',
                'fing03nibadjmiss',     'zfing03nibadj',
...
x_all = returns01_all[[                 'zlnlag1mcreal',
                'finlag1bmmiss',        'zfinlag1bm',
                                        'zfing01dyadj',
                'fing02esgmiss',        'zfing02esg',
                'fing03nibadjmiss',     'zfing03nibadj',
...
x_predict = returns01_predict[[         'zlnlag1mcreal',
                'finlag1bmmiss',        'zfinlag1bm',
                                        'zfing01dyadj',
                'fing02esgmiss',        'zfing02esg',
                'fing03nibadjmiss',     'zfing03nibadj',
...
# Add a layer of 32 neurons with ReLU activation and optional penalty factor.
nnet0.add(Dense(32, activation='relu', kernel_regularizer=regularizers.l1(0.0001)))
...
# Fit the data
history0 = nnet0.fit(x_train, y_train, epochs=3, batch_size=32)
...
# Having determined hyperparameters run the analysis on the whole dataset (excluding Jan 2023)
# to make predictions for January 2023
# Initialize the random seed for the neural network. Nets select random weights to start the process.
# Need to set the numpy seed, which initializes the tensorflow seed.
seed(24754)
set_seed(11610)
...
# Add a layer of 32 neurons with ReLU activation and optional penalty factor.
nnet1.add(Dense(32, activation='relu', kernel_regularizer=regularizers.l1(0.00001)))
...
# Fit the data
history1 = nnet1.fit(x_all, y_all, epochs=3, batch_size=32)
